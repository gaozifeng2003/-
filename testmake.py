...
class MyWindow(QtWidgets.QMainWindow,Ui_Form):
  ...
  def slot_testsave(self):
      if self.textEdit.toPlainText()=="" or self.question==self.textEdit.toPlainText() :
        pass
      else:
          self.question=self.textEdit.toPlainText()
          self.answer=self.textEdit_2.toPlainText()
          self.analysis=self.textEdit_3.toPlainText()
